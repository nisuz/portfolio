...
export default function Contact() {
  ...
  const socialLinks = [
    ...
    { icon: Instagram, name: "Instagram", url: "https://instagram.com", color: "text-foreground" },
    { icon: Facebook, name: "Facebook", url: "https://facebook.com", color: "text-foreground" },
    { icon: Video, name: "TikTok", url: "https://tiktok.com", color: "text-foreground" }
  ]
