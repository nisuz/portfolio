    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-black/90 backdrop-blur-md">
      <div className="flex h-16 items-center justify-between px-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button variant="outline" size="sm" className="hidden md:flex items-center gap-2 hover-lift border-border text-foreground hover:bg-accent/10">
            <Download className="w-4 h-4" />
            Resume
          </Button>
          
          <Link to="/contact">
            <Button variant="outline" size="sm" className="hover-lift text-foreground">
