    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container px-4 mx-auto text-center relative z-10">
            ...
            <div className="terminal-window w-full hover-lift">
              ...
              <div className="p-8 space-y-4">
                <div className="text-left font-mono text-sm">
                  ...
                  <div className="text-lg md:text-xl text-foreground font-semibold min-h-[2rem]">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <Button asChild size="lg" className="bg-background text-foreground border border-border hover:bg-accent hover:text-accent-foreground">
            <a href="contact">
